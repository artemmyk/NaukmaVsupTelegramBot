...
# def get_speciality_info_keyboard(speciality: str):
#     speciality_info_keyboard = InlineKeyboardMarkup
#
#     index = 0
#     for key in bachelor_fen_specialities_info_callback_data.keys()[:-1]:
#         button = InlineKeyboardButton(
#             text=speciality_info_button_text[key],
#             # callback_data=bachelor_fen_specialities_info_callback_data[speciality][key]
#             callback_data=speciality_info_button_text.keys()[index] + "bachelors" + speciality
#         )
#         index += 1
#     for key in bachelor_fen_specialities_links.keys():
#         button =


button_disciplines = InlineKeyboardButton(
    text=speciality_info_button_text["button_disciplines"],
    callback_data=bachelor_fen_specialities_info_callback_data["economics"]["button_disciplines"]
)
button_zno = InlineKeyboardButton(
    text=speciality_info_button_text["button_zno"],
    callback_data=bachelor_fen_specialities_info_callback_data["economics"]["button_zno"]
)
button_students_number = InlineKeyboardButton(
    text=speciality_info_button_text["button_students_number"],
    callback_data=bachelor_fen_specialities_info_callback_data["economics"]["button_students_number"]
)
button_cost = InlineKeyboardButton(
    text=speciality_info_button_text["button_cost"],
    callback_data=bachelor_fen_specialities_info_callback_data["economics"]["button_cost"]
)
button_score_needed = InlineKeyboardButton(
    text=speciality_info_button_text["button_score_needed"],
    callback_data=bachelor_fen_specialities_info_callback_data["economics"]["button_score_needed"]
)
button_count_score = InlineKeyboardButton(
    text=speciality_info_button_text["button_count_score"],
    callback_data=bachelor_fen_specialities_info_callback_data["economics"]["button_count_score"]
)
button_konkurs_ukma = InlineKeyboardButton(
    text=speciality_info_button_text["button_konkurs_ukma"],
    url=bachelor_fen_specialities_links["economics"]["button_konkurs_ukma"]
)
button_speciality_site = InlineKeyboardButton(
    text=speciality_info_button_text["button_speciality_site"],
    url=bachelor_fen_specialities_links["economics"]["button_speciality_site"]
)
button_youtube = InlineKeyboardButton(
    text=speciality_info_button_text["button_youtube"],
    url=bachelor_fen_specialities_links["economics"]["button_youtube"]
)
...
specialities_info_keyboard = InlineKeyboardMarkup() \
