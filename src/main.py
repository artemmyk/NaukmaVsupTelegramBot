...
async def send_welcome(message: types.Message):
    ...
    await message.answer("Привіт, абітурієнте/-ко👋! Я допоможу тобі дізнатися більше про Могилянку і дам відповіді на найпоширеніші питання. Що тебе цікавить?", reply_markup=main_menu_keyboard)
